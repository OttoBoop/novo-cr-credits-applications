# Novo CR — Plano de Longo Prazo: Créditos e Aceleradores

## Contexto

O Novo CR é uma plataforma de educação baseada em dados rodando em produção (ia-educacao-v2.onrender.com), usando três provedores de IA em paralelo: Anthropic, OpenAI e Google. Custo de API é um dos vetores principais de gasto. Este documento lista os objetivos de longo prazo pra conseguir créditos gratuitos e suporte de aceleradores que reduzam ou eliminem esse custo por períodos significativos, e construa visibilidade institucional.
...
- **Ciclo:** avaliação na primeira segunda-feira de cada mês.
...
- **Meta:** aceitação em pelo menos uma aceleradora.
- **Programas:**
  - FGV Ventures batch 20 (Isabel Pinheiro + Luciana Cualheta — contato em andamento)
  - Google for Startups Accelerators (geografia/setor específicos)
  - Gemini Startup Forum (seed–Series A)

### G5. Dossiê canônico do projeto

- **Meta:** materiais reusáveis em qualquer aplicação:
  - Descrição científica de 1 página
  - Time + credenciais (Otavio + apoiadores FGV)
  - Métricas atuais (26 matérias, 100+ atividades, relatório longitudinal real de 9 disciplinas em 4 anos)
  - Roadmap científico até a submissão CNPq em julho
